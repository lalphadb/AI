...
async def test_config():
    ...
    print("\n📋 Test Configuration...")
    from services.rag.config import get_rag_config
...
async def test_embeddings():
    ...
    assert result2.cached, "Cache non utilisé"
...
async def test_context_injector():
    ...
    assert not result2.injected, "Injection sur salutation"
    ...
    if result3.injected:
        ...
        print("  ⚠️ Pas de contexte pertinent trouvé")
...
async def test_full_pipeline():
    ...
    from services.rag import inject_rag_context, search_documents
    ...
    if result.injected:
        ...
        print("  ⚠️ Pas de contexte trouvé (score min non atteint)")
