...
async def create_plan(params: dict) -> str:
    ...
    plan_lines.extend([
        f"",
        f"📌 Étapes suggérées:",
        f"1. Analyser la situation actuelle",
        f"2. Identifier les ressources nécessaires",
        f"3. Exécuter les actions",
        f"4. Vérifier les résultats",
        f"5. Documenter les changements",
        f"",
        f"⏭️ Prochaine action: Commencer par l'étape 1"
    ])
